...
import ChatIcon from '@/images/bottomBar-chat.svg';
...
.nav-icon {
  width: 6vw; /* 使用视口宽度来调整图标大小 */
  height: 6vw;
  margin-bottom: 1vh; /* 使用视口高度来调整间距 */
}

.nav-text {
  font-size: 3vw; /* 使用视口宽度来调整字体大小 */
  color: #333;
}

@media (min-width: 768px) {
  .nav-icon {
    width: 24px; /* 在较大屏幕上设置固定大小 */
    height: 24px;
  }

  .nav-text {
    font-size: 12px; /* 在较大屏幕上设置固定字体大小 */
  }
}
</style>
